    ...
    if (e1.date_obj.timestamp === this.editFlag.date_obj.timestamp) {
      if (this.flagsForm.controls[0]?.get('flag_style')?.value === 1 && this.editFlag.edit === 'edit-flag-1') {
        ...
        if (this.editFlag.flags2) {
          ...
          console.log('ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ', find)
          console.log('ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ', find2)
          console.log('ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ', indexDelet)

          // // { TEST-3 } Here separates flag1 from flag2
            if (find.length === 1 && find2.length === 1 && !this.editFlag.flags2[0]) { // flag 1 na mesma data
            ...
            else if (find.length === 1 && find2.length === 0 && !this.editFlag.flags2[0]) { // flag 1 quando não existe data 
            ...
            else if (this.editFlag.flags2[0]) { // flag 1 seprando da flag2
